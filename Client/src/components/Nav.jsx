...
const Nav = () => {
    return (
        <nav className='h-14 w-full p-2 bg-white sticky top-0 left-0 z-50 shadow'>
            <div className='flex h-full ml-2 justify-between'>
                <div className='flex items-center gap-4'>
                    ...
                    <div className='flex items-center opacity-70'>
                        ...
                        <input type="text" id='search' placeholder='Search' className='bg-transparent p-2 hidden' />
                    </div>
                </div>
                <div>
                    <ul className='flex items-center h-full gap-5 opacity-70'>
                        ...
                        <li className='hidden flex-1 flex-shrink-0'>
                            <Link to='/profile'>
                                <div>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
